-- source: https://github.com/gamesys/moonshine/blob/master/extensions/luac/yueliang.lua
-- yueliang was published under the MIT license
-- https://web.archive.org/web/20200125013735/http://luaforge.net/projects/yueliang/
...
return {
	...
	compile = function(self, source, name)
		...
		local func = luaY:parser(self.LuaState, zio, nil, "@"..name)
		-- luaU:make_setS returns a string chunk writer
		local writer, buff = luaU:make_setS()
		-- luaU:dump builds a binary chunk
		luaU:dump(self.LuaState, func, writer, buff)
